    ...
    <div className="space-y-8">
        ...
        <Card className="animate-fade-in-up animation-delay-200">
            <CardHeader>
                ...
                <CardDescription>Estos son los últimos registros de asistencia guardados. Cada registro de asistencia genera un parte diario. Haz clic para ver detalles o editar.</CardDescription>
            </CardHeader>
            <CardContent>
                {loading ? (
