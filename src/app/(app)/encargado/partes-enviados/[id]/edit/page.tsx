...
export default function ModificarReportePage() {
  ...
  const handleSaveChanges = async () => {
    ...
    if(result.success) {
        toast({ title: "Éxito", description: "El reporte se ha actualizado correctamente." });
        router.push('/encargado/partes-enviados');
    } else {
  ...
  return (
    <div className="space-y-6">
       <div>
        <h1 className="text-3xl font-bold font-headline text-primary">Modificar Reporte</h1>
        <p className="text-muted-foreground mt-1 capitalize">Estás editando el reporte para el proyecto: <span className="font-semibold">{proyectoNombre}</span></p>
      </div>
