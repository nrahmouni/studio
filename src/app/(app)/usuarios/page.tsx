...
// import { getUsuariosByEmpresaId } from '@/lib/actions/user.actions'; // Commented out
...
export default function UsuariosPage() {
  ...
  // Minimal return for parsing test
  return (
    <div className="container mx-auto py-8 px-4">
      <div className="flex justify-between items-center mb-8">
        <h1 className="text-3xl font-bold font-headline text-primary">
          Gestión de Usuarios (Test)
        </h1>
              ...
              return (
                <Card key={usuario.id} className="flex flex-col hover:shadow-xl transition-shadow duration-300">
                  ...
                  <CardContent className="flex-grow space-y-2 text-sm">
                    ...
                    {obrasAsignadasActuales && obrasAsignadasActuales.length > 0 && (
                      <p><span className="font-medium">Obras Asignadas:</span> {obrasAsignadasActuales.length}</p>
                    )}
                  </CardContent>
