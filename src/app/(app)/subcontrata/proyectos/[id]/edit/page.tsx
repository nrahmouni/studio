...
export default function EditSubcontrataProyectoPage() {
  ...
  const handleSubmit = async (data: EditProyectoFormData) => {
    ...
    // The subcontrataId needs to be added for the updateProyecto to have full context, although it is not edited here.
    ...
    const result = await updateProyecto(projectId, { ...data, subcontrataId });
    if(result.success) {
