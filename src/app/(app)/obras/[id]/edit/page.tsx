...
import { CalendarIcon, Loader2, Briefcase, ArrowLeft, Save, AlertTriangle } from 'lucide-react';
        ...
        <CardHeader className="bg-primary/5 p-6">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <CardDescription className="text-md text-muted-foreground">Modifica los detalles del proyecto.</CardDescription>
            </div>
          </div>
        </CardHeader>
