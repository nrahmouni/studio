      ...
      <header className="sticky top-0 z-50 bg-primary/95 text-primary-foreground py-3 shadow-lg backdrop-blur-md">
        <div className="container mx-auto px-4 flex justify-between items-center">
          ...
          <nav className="flex items-center gap-4">
            <Link href="/es/dashboard" className="text-sm hover:underline">{t('nav.spanish')}</Link>
            <Link href="/en/dashboard" className="text-sm hover:underline">{t('nav.english')}</Link>
            <Link href="/fr/dashboard" className="text-sm hover:underline">{t('nav.french')}</Link>
