        ...
        <section className="py-16 md:py-24 bg-background">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-foreground/70 mt-2 max-w-2xl mx-auto">Descubre las herramientas diseñadas para potenciar tu empresa de construcción y reformas, mejorando la eficiencia y el control.</p>
            </div>
        ...
        <section className="py-16 md:py-24 bg-background">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-foreground/70 mt-2 max-w-2xl mx-auto">ObraLink no es solo una app, es tu socio estratégico para la eficiencia, el control y la modernización de tus proyectos.</p>
            </div>
