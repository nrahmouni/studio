  ...
  useEffect(() => {
    const fetchReportes = async () => {
      ...
      if (encargadoId) {
        ...
        setReportes(data.sort((a, b) => parseISO(b.fecha).getTime() - parseISO(a.fecha).getTime()));
                ...
                {loading ? (
                    ...
                    <Card className="animate-fade-in-up">
                        <CardContent className="p-8">
                            <p className="text-muted-foreground text-center">No hay registros de asistencia guardados.</p>
                        </CardContent>
                    </Card>
                )}
            </CardContent>
