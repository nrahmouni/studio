...
import { Settings, Palette, Bell, ShieldCheck, Info, Database, PlusCircle } from "lucide-react";
        ...
        <>
          ...
          <Button variant="outline" className="w-full opacity-50 cursor-not-allowed" title="Autenticación de dos factores (Próximamente)">
           ...
           <Link href="/auth/register/empresa" passHref>
            <Button variant="outline" className="w-full mt-2 text-accent border-accent hover:bg-accent/10 hover:text-accent">
                <PlusCircle className="mr-2 h-4 w-4"/>
                Registrar Nueva Empresa
            </Button>
          </Link>
          <Link href="/dashboard" passHref>
            <Button variant="outline" className="w-full mt-2">Volver al Simulador de Roles</Button>
          </Link>
        </>
      )
    }
